...
<div class="form-group">
    <label for="education"><i class="red">*</i> Образование</label>
...
<div class="form-group">
    <label for="vk_link"><i class="red">*</i> Ссылка ВК</label>
    <input type="url" class="form-control" name="vk_link" id="vk_link" required
           @if(old('vk_link'))
               value="{{old('vk_link')}}"
           @else
               @if(isset($item))
...
<div class="form-group">
    <label for="telegram_link"><i class="red">*</i> Ссылка телеграм</label>
    <input type="url" class="form-control" name="telegram_link" id="telegram_link" required
           @if(old('vk_link'))
