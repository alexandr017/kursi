...
<div class="about_partners-cont swiper_styles-slider swiper-initialized swiper-horizontal swiper-backface-hidden">
    ...
    <div class="swiper_styles-pagination_cont">
        <div class="about_partners-cont-button-prev swiper_styles-button-prev swiper-button-disabled swiper-button-lock" tabindex="-1" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-5ec025a551083b847" aria-disabled="true"></div>
        <div class="about_partners-cont-pagination swiper_styles-pagination swiper-pagination swiper-pagination-fraction swiper-pagination-horizontal swiper-pagination-lock"><span class="swiper-pagination-current">1</span> / <span class="swiper-pagination-total">1</span></div>
        <div class="about_partners-cont-button-next swiper_styles-button-next swiper-button-disabled swiper-button-lock" tabindex="-1" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-5ec025a551083b847" aria-disabled="true"></div>
    </div>
