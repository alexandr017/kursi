...
includeComponent('components/molecules/breadcrumbs');
?>
{{--<div class="container">--}}
{{--   start breadcrumbs --}}
    ...
    <div class="breadcrumbs-block">
        <div class="breadcrumbs">
            <a class="btn btn-tertiary-light btn-md breadcrumbs_link" href="https://vsezaimyonline.ru" target="_blank">
            ...
            <a class="btn btn-tertiary-light btn-md breadcrumbs_link" href="https://vsezaimyonline.ru" target="_blank">
                <span class="btn-tertiary-text">UX/UI</span>
                <svg class="btn-tertiary-icon" width="12" height="13" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4 10.5L8 6.5L4 2.5" stroke="black"  stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </a>

            {{--    это демонстрация, кнопка может быть в этом компоненте, по фигме    --}}
